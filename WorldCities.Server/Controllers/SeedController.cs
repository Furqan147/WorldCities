    ...
    public class SeedController : ControllerBase
    {
        ...
        public async Task<ActionResult> Import()
        {
            ...
            for (int nRow = 2; nRow <= nEndRow; nRow++)
            {
                ...
                // skip this country if it already exists in the data
                if (countriesByName.ContainsKey(countryName))
                    continue;
                // create the Country entity and fill it with xlsx da
                ...
                // store the country in our lookup to retrieve its Id
            ...
            for (int nRow = 2; nRow <= nEndRow; nRow++)
            {
                ...
                // skip this city if it already exists in the databas
